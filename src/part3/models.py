...
# You might want to put general configuration into its own separate file:
...
# Since we are using Python's `dataclass`,
# we need to set default values for fields
# and configure options like `init=False`, `repr=False`.
